...
!function (a) {
    ...
    function o(a) {
        ...
        var b, c = a.children, d = S.exec(a.tag || "");
        return delete a.children, a.tag = d[1] || "div", a.id = a.id || (d[2] || "").substr(1), d = (d[3] || "").split("."), d[0] = a.className || "", a.className = d.join(" "), b = H.createElement(a.tag), delete a.tag, f(a, function (c, d) {
            if (c)if ("css" === d)r(b, a.css); else if ("text" === d)null != c && k(b, H.createTextNode(c)); else if ("html" === d)null != c && (b.innerHTML = c); else if ("ply" === d)b.setAttribute(M, c); else if (d in b)try {
                b[d] = c
            } catch (e) {
                b.setAttribute(d, c)
    ...
    function t(a, b) {
        return o({
            ...
            children: b.baseHtml ? [{
                ...
                children: [b.flags.closeBtn && {ply: ":close", tag: ".ply-x", text: J.cross}, {
                    tag: ".ply-inside",
                    children: a
                }]
            }] : a
    ...
    function v(a, b, c) {
        ...
        var e = b.el;
        return a.el = e && e.cloneNode ? b.clone ? e.cloneNode(!0) : e : o({html: e || ""}), a.layerEl = t(a.el, b), a.contentEl = w(a.layerEl), a.context = new y(a.layerEl), k(a.wrapEl, a.layerEl), a.bodyEl = b.body && i(b.body) || H.body, a.wrapEl.tabIndex = -1, r(a.wrapEl, {
            top: 0,
            left: 0,
            right: 0,
            bottom: 0,
    ...
    var E = 1, F = function () {
    }, G = window, H = G.document, I = G.setTimeout, J = {ok: "OK", cancel: "Cancel", cross: "✖"}, K = function () {
    ...
    }(), L = {esc: 27}, M = "data-ply", N = window.jQuery || window.Zepto || window.ender || window.$, O = {
        clone: !0,
        zIndex: 1e4,
        rootTag: "form",
        baseHtml: !0,
    ...
    return x.stack = {
        ...
        B[a.replace(/^\s+|\s+$/g, "").replace(/\s+/g, " ")] = function (d, e) {
            ...
            return null != d || ":root" === a ? (d = c ? d : A(d), f(c ? d : d.children, function (b, c) {
                var d = ((e || a) + " " + c).replace(/^:\w+\s+/, ""), f = z(b) ? b : B(d, A(b, c), d);
                k(i, f)
        ...
        c(D("confirm", a, b, {ok: !0, cancel: !0}))
    }), C("prompt", function (a, b, c) {
        c(D("prompt", a, b, {ok: !0, cancel: !0}))
        ...
        if (z(a))return c(new x(h(b || {}, {el: a})));
        d || (d = b, b = {});
        var e = C[a] || C["default"];
        ...
        return b instanceof Object && !z(b) ? (c = c || {}, a(function (a, d) {
            var e, g, i, j = c.initState, k = b, l = {}, m = function (a, b) {
                (c.progress || F)(h({name: e.$name, index: e.$index, length: o, stack: k, current: e, widget: b}, a), l)
            }, n = function (a, b, c) {
